<template>
  <div class="s-form-item" :class="{
    ...
    <label :for="prop" class="s-form-item-label" :style="labelStyle" v-if="label">
      {{label + form.labelSuffix}}
    </label>
    <div class="s-form-item-content" :style="contentStyle">
      <slot></slot>
      <transition name="s-zoom-in-top">
        <div class="s-form-item-error" v-if="validateState === 'error' && showMessage && form.showMessage">{{validateMessage}}</div>
      </transition>
    </div>
  </div>
</template>
