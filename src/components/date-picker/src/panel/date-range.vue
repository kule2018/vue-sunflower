<template>
  <transition name="s-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      :style="{ width: width + 'px' }"
      class="s-picker-panel s-date-range-picker"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="s-picker-panel-body-wrapper">
        <slot name="sidebar" class="s-picker-panel-sidebar"></slot>
        <div class="s-picker-panel-sidebar" v-if="shortcuts">
          <button
            type="button"
            class="s-picker-panel-shortcut"
            v-for="shortcut in shortcuts"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="s-picker-panel-body">
          <div class="s-date-range-picker-time-header" v-if="showTime">
            <span class="s-date-range-picker-editors-wrap">
              <span class="s-date-range-picker-time-picker-wrap">
                <s-input
                  size="small"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="s-date-range-picker-editor"
            ...
            <span class="s-date-range-picker-editors-wrap is-right">
              <span class="s-date-range-picker-time-picker-wrap">
                <s-input
                  size="small"
          ...
          <div class="s-picker-panel-content s-date-range-picker-content is-left">
            <div class="s-date-range-picker-header">
              <button
                type="button"
                @click="prevYear"
                class="s-picker-panel-icon-btn s-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="prevMonth"
                class="s-picker-panel-icon-btn s-icon-arrow-left"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="s-picker-panel-content s-date-range-picker-content is-right">
            <div class="s-date-range-picker-header">
              <button
                type="button"
                @click="nextYear"
                class="s-picker-panel-icon-btn s-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="nextMonth"
                class="s-picker-panel-icon-btn s-icon-arrow-right"></button>
              <div>{{ rightLabel }}</div>
            </div>
            <date-table
              selection-mode="range"
      ...
      <div class="s-picker-panel-footer" v-if="showTime">
        <a
          class="s-picker-panel-link-btn"
          @click="handleClear">{{ t('el.datepicker.clear') }}</a>
        <button
          type="button"
          class="s-picker-panel-btn"
          @click="handleConfirm()"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: { TimePicker, DateTable, SInput }
  };
</script>
