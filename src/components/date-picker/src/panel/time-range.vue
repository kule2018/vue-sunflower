<template>
  <transition
    ...
    <div
      ...
      class="s-time-range-picker s-picker-panel"
      :class="popperClass">
      <div class="s-time-range-picker-content">
        <div class="s-time-range-picker-cell">
          <div class="s-time-range-picker-header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds }"
            class="s-time-range-picker-body s-time-panel-content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="s-time-range-picker-cell">
          <div class="s-time-range-picker-header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds }"
            class="s-time-range-picker-body s-time-panel-content">
            <time-spinner
      ...
      <div class="s-time-panel-footer">
        <button
          type="button"
          class="s-time-panel-btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="s-time-panel-btn confirm"
          @click="handleConfirm()"
