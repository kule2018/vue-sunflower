    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="s-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText" class="s-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: Array,
        default() {
          return ['s-icon-star-on', 's-icon-star-on', 's-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 's-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 's-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
