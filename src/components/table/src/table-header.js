              ...
              <tr>
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    {
                      column.filterable
                         ? <span class="s-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['s-icon-arrow-down', column.filterOpened ? 's-icon-arrow-up' : ''] }></i></span>
                        : ''
                    }
                    </div>
                  </th>
